...
### О проекте
Этот проект является консольным текстовым редактором, который является одним целым файлом и весит 2 КБ. 

В отличие от других консольных редакторов, этот зависит намертво от cmd.exe.
